...
//==============================================================================
KnobComponent::KnobComponent(juce::RangedAudioParameter* p,
...
void KnobComponent::sliderDragStarted(juce::Slider* slider)
{
...
void KnobComponent::sliderDragEnded(juce::Slider* slider)
{
    if (slider == &innerKnob.getSlider())
    {
        dragging = false;
...
void KnobComponent::mouseEnter([[maybe_unused]] const juce::MouseEvent& event)
{
...
void KnobComponent::mouseExit([[maybe_unused]] const juce::MouseEvent& event)
{
